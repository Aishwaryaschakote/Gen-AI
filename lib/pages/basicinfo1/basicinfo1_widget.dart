...
import 'basicinfo1_model.dart';
export 'basicinfo1_model.dart';

/// create a page named as Basic information which takes input fields as
/// follows: full name, gender(dropdown box with 4 option values male, female,
/// other and prefer not to say) , age,language(dropdown with 3 options
/// english, kannada, hindi), height(in cm), weight (in kg).
///
/// at the end create one save and next button with arrow .
class Basicinfo1Widget extends StatefulWidget {
  const Basicinfo1Widget({super.key});

  static String routeName = 'basicinfo1';
  static String routePath = '/basicinfo1';

  @override
  State<Basicinfo1Widget> createState() => _Basicinfo1WidgetState();
}

class _Basicinfo1WidgetState extends State<Basicinfo1Widget> {
  late Basicinfo1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Basicinfo1Model());
                    ...
                    child: FFButtonWidget(
                      onPressed: ((_model.fullNameTextController.text == '') ||
                          ...
                          : () async {
                              ...
                              context.pushNamed(MedicalinfoWidget.routeName);
